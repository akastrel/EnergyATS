...
- `stop_generator` — безопасно снять нагрузку, восстановить Grid path и
  остановить управляемый генератор; при отсутствующей Grid дом до её возврата
  питается от МАП;
...
Текущий Energy ATS их не вызывает. Удалить их можно в следующем согласованном
