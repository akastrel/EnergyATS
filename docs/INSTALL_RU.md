# Обновление до Energy ATS 0.3.6

0.3.6 сохраняет силовую логику 0.3.1. Ручные команды передаются непосредственно
...
После обновления списка Apps установить версию 0.3.6.
...
предложенную конфигурацию 0.3.6 и убедиться, что старых полей больше нет.
...
0.3.6 использует внутренний файл:
...
Если 0.3.6 впервые запущен при уже работающем генераторе без своего журнала,
