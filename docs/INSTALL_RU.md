# Обновление до Energy ATS 0.3.12

0.3.12 сохраняет силовую логику 0.3.1. Ручные команды передаются непосредственно
...
После обновления списка Apps установить версию 0.3.12.
...
предложенную конфигурацию 0.3.12 и убедиться, что старых полей больше нет.
...
0.3.12 использует внутренний файл:
...
Если 0.3.12 впервые запущен при уже работающем генераторе без своего журнала,
