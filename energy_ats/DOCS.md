# Energy ATS 1.0.4 — руководство пользователя
...
Начиная с 1.0.4 Logbook строится как причинно-следственный журнал. Для ключевых сценариев события разделены на четыре типа:
